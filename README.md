...
A simple and clean weather application built using Flutter. This app fetches real-time weather data and displays it based on the user's current location.
